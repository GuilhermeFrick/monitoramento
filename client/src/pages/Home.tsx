...
function FleetView({ view, onToast }: { view: "fleet" | "drivers" | "training" | "traffic" | "settings"; onToast: (message: string) => void }) {
  const config = {
