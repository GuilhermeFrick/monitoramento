      ...
      : <div className="wsp-canvas-stage" ref={stageRef}>
          ...
          >
            <defs>
              ...
              <marker id="wsp-seta-ativa" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="#8C6AB0" /></marker>
